...
def count_errors(reference, scores, maximize, results_file, verbose=False):
...
def main(reference, scores, maximize, out, verbose):

    results = count_errors(reference, scores, maximize, out, verbose )
...
if __name__ == '__main__':
    ...
    #print('enc:', enc)
    main(args.reference, args.scores, args.maximize, args.results_file, args.verbose)